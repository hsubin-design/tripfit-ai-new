...
// 진짜 최종 화면.
// 버그 수정(2026-09-14, 3차) — 중앙보다 살짝 위에 완료 콘텐츠(체크
// 아이콘/제목/설명/보조문구)를 배치한다. 부모(page.tsx)의 flex-col
...
export default function StepFinished({ onRestart }: Props) {
  return (
    <div className="flex w-full flex-1 flex-col items-center justify-center px-5 pb-16 text-center">
      <div
      ...
      <h1 className="heading-page mt-6">제출이 완료되었습니다.</h1>
      <p className="text-body-secondary mt-2">비교와 응답을 보내주셔서 감사합니다.</p>
      <p className="text-body-secondary mt-1">이제 이 페이지를 닫아도 괜찮아요.</p>
